...
const Spinner = () => {
    return (
        <svg className="spinner" xmlns="http://www.w3.org/2000/svg" style={{margin: '0 auto', background: 'none', display: 'block'}} max-width="200px" max-height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
